...
public class MessageEditorDisallowEdit implements IMessage
{
	...
	public MessageEditorDisallowEdit(int xCoord, int yCoord, int zCoord)
	{
	...
	public MessageEditorDisallowEdit()
	{
