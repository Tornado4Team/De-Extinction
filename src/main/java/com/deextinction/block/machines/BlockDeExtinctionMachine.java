...
public class BlockDeExtinctionMachine extends BlockContainerHorizontalWorking
{

	public BlockDeExtinctionMachine(float hardness, float resistance, Material material, SoundType soundType, CreativeTabs tab)
	{
	...
	{
		return new TileDeExtinctionMachine();
	}
