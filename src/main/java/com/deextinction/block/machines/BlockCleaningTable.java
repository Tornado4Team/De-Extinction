...
public class BlockCleaningTable extends BlockContainerHorizontalWorking
{

	public BlockCleaningTable(float hardness, float resistance, Material material, SoundType soundType, CreativeTabs tab)
	{
	...
	{
		EnumFacing enumfacing = (EnumFacing) stateIn.getValue(BlockCleaningTable.FACING);
