...
{
	public static final PropertyInteger NUMBER_OF_EGGS = PropertyInteger.create("eggs", 1, BlockEgg.EnumNumber.FOUR.getNumber());
	...
	{
		return BlockFourEggs.NUMBER_OF_EGGS;
	}
