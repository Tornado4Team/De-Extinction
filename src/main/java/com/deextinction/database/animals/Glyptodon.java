...
public class Glyptodon extends DeExtinctedAnimal implements ISyringe
{
	public static final String NAME = "glyptodon";

	public Glyptodon()
	{
		super(Glyptodon.NAME);
	}
	...
	{
		return mother instanceof EntityCow || mother instanceof EntityLlama || mother instanceof EntitySheep || mother instanceof EntityPig || mother instanceof EntityGlyptodon;
	}

	@Override
	public EntityCreature getEntity(World worldIn)
	{
		return new EntityGlyptodon(worldIn);
	}

	@Override
	public String getEntityName()
	{
		return DeExtinction.getNameFromEntityClass(EntityGlyptodon.class);
	}
