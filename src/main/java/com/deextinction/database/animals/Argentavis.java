...
public class Argentavis extends DeExtinctedAnimal implements IEgg
{
	public static final String NAME = "argentavis";

	public Argentavis()
	{
		super(Argentavis.NAME);
	}
	...
	{
		return new EntityArgentavis(worldIn);
	}

	@Override
	public String getEntityName()
	{
		return DeExtinction.getNameFromEntityClass(EntityArgentavis.class);
	}
	...
	public void initAttributes()
	{
		...
		this.attributes.setScaleBaby(0.5D, 1.0D);
		this.attributes.setScaleAdult(0.5D, 1.0D);
		this.attributes.setHealth(6.0D, 12.0D);
		this.attributes.setKnockbackResistance(0.2D, 0.3D);
		this.attributes.setMovementSpeed(0.35D, 0.35D);
		...
		this.attributes.setFlyingSpeed(0.5D, 0.5D);
	}
}
