...
public class SimplexNoise
{
	...
	private short p[] = new short[this.p_supply.length];
	...
	public SimplexNoise()
	{
		this(SimplexNoise.DEFAULT_SEED);
	}
	...
	public float noise(float xin, float yin)
	{
		...
		double s = (xin + yin) * SimplexNoise.F2;
		...
		double x1 = x0 - i1 + SimplexNoise.G2;
		double y1 = y0 - j1 + SimplexNoise.G2;
		double x2 = x0 - 1.0 + 2.0 * SimplexNoise.G2;
