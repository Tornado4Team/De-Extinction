...
{
	protected IBlockState logState;
	protected IBlockState leavesState;
	protected IBlockState saplingState;

	public WorldGenDeExtinctedTree(boolean doBlockNotify, IBlockState logState, IBlockState leavesState, IBlockState saplingState)
	{
		super(doBlockNotify);
	...
	{
		IBlockState stateToCheck = worldIn.getBlockState(pos);
		return stateToCheck.getMaterial() == Material.AIR || stateToCheck.getMaterial() == Material.VINE || stateToCheck.getMaterial() == Material.WATER || stateToCheck.getBlock() == this.saplingState.getBlock();
	}
}
