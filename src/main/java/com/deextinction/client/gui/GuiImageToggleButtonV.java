...
public class GuiImageToggleButtonV extends GuiButton
{
	/** State of the button. */
	...
	public GuiImageToggleButtonV(int id, int xPos, int yPos, boolean flag, int xPosTexture, int yPosTexture, int width, int height, ResourceLocation resourceLocation)
	{
	...
	public GuiImageToggleButtonV(int id, int xPos, int yPos, int xPosTexture, int yPosTexture, int width, int height, ResourceLocation resourceLocation)
	{
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
	{
		if (this.visible)
		{
			...
			if (this.enabled)
			{
				...
				{
					if (this.hovered)
						this.drawTexturedModalRect(this.x, this.y, this.xPosTexture, this.yPosTexture + this.height, this.width, this.height);
					else
						this.drawTexturedModalRect(this.x, this.y, this.xPosTexture, this.yPosTexture + this.height, this.width, this.height);
				}
				else
				...
				this.drawTexturedModalRect(this.x, this.y, this.xPosTexture, this.yPosTexture + 2 * this.height, this.width, this.height);
