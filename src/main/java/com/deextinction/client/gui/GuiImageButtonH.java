...
public class GuiImageButtonH extends GuiButton
{
	/**
	...
	public GuiImageButtonH(int id, int xPos, int yPos, int xPosTexture, int yPosTexture, int width, int height, ResourceLocation resourceLocation)
	{
