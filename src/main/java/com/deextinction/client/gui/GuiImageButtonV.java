...
public class GuiImageButtonV extends GuiButton
{
	/**
	...
	public GuiImageButtonV(int id, int xPos, int yPos, int xPosTexture, int yPosTexture, int width, int height, ResourceLocation resourceLocation)
	{
