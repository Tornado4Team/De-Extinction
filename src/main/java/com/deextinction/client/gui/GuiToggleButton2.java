...
public class GuiToggleButton2 extends GuiButton
{
	 ...
	 */
	public GuiToggleButton2(int id, int xPos, int yPos, boolean flag, String firstDisplayString, String secondDisplayString, int normalColor, int selectedColor, int disabledColor, Minecraft mc)
	{
		...
		int widthFirst = mc.fontRenderer.getStringWidth(firstDisplayString);
		int widthSecond = mc.fontRenderer.getStringWidth(secondDisplayString);
		if (widthSecond > widthFirst)
			this.width = widthSecond + 10;
		else
			this.width = widthFirst + 10;
		this.initPosX = xPos;
		this.x = this.initPosX - this.width / 2;
	 ...
	 * Note that the xPos and yPos is the center of the button.
	 */
	public GuiToggleButton2(int id, int xPos, int yPos, String firstDisplayString, String secondDisplayString, int normalColor, int selectedColor, int disabledColor, Minecraft mc)
	{
	 ...
	 * Note that the xPos and yPos is the center of the button.
	 */
	public GuiToggleButton2(int id, int xPos, int yPos, boolean flag, String firstDisplayString, String secondDisplayString, Minecraft mc)
	{
	 ...
	 * Note that the xPos and yPos is the center of the button.
	 */
	public GuiToggleButton2(int id, int xPos, int yPos, String firstDisplayString, String secondDisplayString, Minecraft mc)
	{
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
	{
		if (this.visible)
		{
			...
			this.drawCenteredString(fontrenderer, text, this.x + this.width / 2, this.y + (this.height - 8) / 2, l);
		}
	}
	...
	public void setFirstDisplayString(Minecraft mc, String text)
	{
		if (!text.isEmpty())
		{
			...
			int widthFirst = mc.fontRenderer.getStringWidth(this.displayString);
			int widthSecond = mc.fontRenderer.getStringWidth(this.secondDisplayString);
			if (widthSecond > widthFirst)
				this.width = widthSecond;
			else
				this.width = widthFirst;
			this.width = mc.fontRenderer.getStringWidth(text) + 10;
			this.x = this.initPosX - this.width / 2;
		}
		else
