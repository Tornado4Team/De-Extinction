...
public class ResettableModelRenderer extends ModelRenderer
{
	...
	public void setRotateAngle(float rotateAngleX, float rotateAngleY, float rotateAngleZ)
	{
		this.rotateAngleX = rotateAngleX;
		this.rotateAngleY = rotateAngleY;
		this.rotateAngleZ = rotateAngleZ;
		this.firstRotateAngleX = rotateAngleX;
		this.firstRotateAngleY = rotateAngleY;
		this.firstRotateAngleZ = rotateAngleZ;
	}
