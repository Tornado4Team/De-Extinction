...
public class EntityAIJump extends EntityAIBase
{
	...
	public EntityAIJump(EntityDeExtinctedDolphin p_i48938_1_, int p_i48938_2_)
	{
	...
	private boolean func_211695_a(BlockPos p_211695_1_, int p_211695_2_, int p_211695_3_, int p_211695_4_)
	{
		...
		return this.dolphin.world.getBlockState(blockpos).getMaterial().isLiquid() && !this.dolphin.world.getBlockState(blockpos).getMaterial().blocksMovement();
	}

	private boolean func_211696_b(BlockPos p_211696_1_, int p_211696_2_, int p_211696_3_, int p_211696_4_)
	{
		return this.dolphin.world.getBlockState(p_211696_1_.add(p_211696_2_ * p_211696_4_, 1, p_211696_3_ * p_211696_4_)).getMaterial() == Material.AIR && this.dolphin.world.getBlockState(p_211696_1_.add(p_211696_2_ * p_211696_4_, 2, p_211696_3_ * p_211696_4_)).getMaterial() == Material.AIR;
	}
	...
	{
		EnumFacing enumfacing = this.dolphin.getAdjustedHorizontalFacing();
		this.dolphin.motionX += (double) enumfacing.getFrontOffsetX() * 0.6D;
		this.dolphin.motionY += 0.7D;
		this.dolphin.motionZ += (double) enumfacing.getFrontOffsetZ() * 0.6D;
	...
	public void tick()
	{
		...
		if (!flag)
		{
			IBlockState ifluidstate = this.dolphin.world.getBlockState(new BlockPos(this.dolphin));
			this.field_205151_c = ifluidstate.getMaterial().isLiquid();
		}
