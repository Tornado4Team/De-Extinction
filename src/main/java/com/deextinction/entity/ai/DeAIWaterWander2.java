...
public class DeAIWaterWander2 extends EntityAIBase
{
	private EntityDeExtinctedAnimal animal;
	private DeAIWaterWander2.SwimType swimType;
	...
	public DeAIWaterWander2(EntityDeExtinctedAnimalAquatic creature, double speed, double distanceToTargetSq, int duration, int searchRange, int deepthInterval)
	{
		this(creature, DeAIWaterWander2.SwimType.NORMAL, speed, distanceToTargetSq, duration, searchRange, deepthInterval);
	}

	public DeAIWaterWander2(EntityDeExtinctedAnimalAquatic creature, DeAIWaterWander2.SwimType swimType, double speed, double distanceToTargetSq, int duration, int searchRange, int deepthInterval)
	{
	...
	{
		return this.timer-- > 0 && this.animal.isEntityAlive() && this.animal.isInWater();
	}
	...
	public BlockPos findWaterTarget()
	{
		...
		if (this.swimType == DeAIWaterWander2.SwimType.SURFACE)
		{
		...
		else if (this.swimType == DeAIWaterWander2.SwimType.NEAR_SURFACE)
		{
			BlockPos surfacePos = this.animal.getSurface(this.animal);
			if (surfacePos != null)
		...
		else if (this.swimType == DeAIWaterWander2.SwimType.DEEP_WATER)
		{
			BlockPos surfacePos = this.animal.getSurface(this.animal);
			if (surfacePos != null)
			{
