...
public class EntityGlyptodon extends EntityDeExtinctedAnimal
{
	...
	static
	{
		EntityGlyptodon.foodList.add(Items.APPLE);
		EntityGlyptodon.foodList.add(Items.BREAD);
		EntityGlyptodon.foodList.add(Items.WHEAT);
	}
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(4, new DeAIEatDroppedItem(this, 1.0D, 10, 16.0D, EntityGlyptodon.foodList));
		this.tasks.addTask(4, new DeAIFollowFood(this, 1.0D, 30, EntityGlyptodon.foodList));
	...
	{
		return (DeExtinctedAnimal) DeDatabase.LIST_DE_EXTINCTED.get(Glyptodon.NAME);
	}
	...
	{
		return EntityGlyptodon.foodList;
	}
