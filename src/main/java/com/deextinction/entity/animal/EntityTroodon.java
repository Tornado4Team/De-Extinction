...
public class EntityTroodon extends EntityDeExtinctedAnimal
{
	...
	static
	{
		EntityTroodon.foodList.add(Items.APPLE);
		EntityTroodon.foodList.add(Items.BREAD);
		EntityTroodon.foodList.add(Items.WHEAT);
	}
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(4, new DeAIEatDroppedItem(this, 1.0D, 10, 16.0D, EntityTroodon.foodList));
		this.tasks.addTask(4, new DeAIFollowFood(this, 1.0D, 30, EntityTroodon.foodList));
	...
	{
		return (DeExtinctedAnimal) DeDatabase.LIST_DE_EXTINCTED.get(Troodon.NAME);
	}
