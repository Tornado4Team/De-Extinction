...
public class EntityToxodon extends EntityDeExtinctedAnimal
{
	...
	static
	{
		EntityToxodon.foodList.add(Items.APPLE);
		EntityToxodon.foodList.add(Items.BREAD);
		EntityToxodon.foodList.add(Items.WHEAT);
	}
	...
	protected void initEntityAI()
	{
		...
		this.tasks.addTask(4, new DeAIEatDroppedItem(this, 1.0D, 10, 16.0D, EntityToxodon.foodList));
		this.tasks.addTask(4, new DeAIFollowFood(this, 1.0D, 30, EntityToxodon.foodList));
	...
	{
		return (DeExtinctedAnimal) DeDatabase.LIST_DE_EXTINCTED.get(Toxodon.NAME);
	}
	...
	{
		this.playSound(SoundEvents.ENTITY_COW_STEP, 0.5F, 0.6F - 0.3F * this.getGrowthScaled());
	}
